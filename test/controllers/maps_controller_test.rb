...
class MapsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create map" do
    assert_difference('Map.count') do
      post maps_url, params: { map: { background: @map.background, x: @map.x, y: @map.y, z: @map.z } }
    end
  ...
  test "should update map" do
    patch map_url(@map), params: { map: { background: @map.background, x: @map.x, y: @map.y, z: @map.z } }
